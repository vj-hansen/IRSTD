...
def mat2gray(m):
    ...
    # https://github.com/estory1/DePaul_Medix_Lab/blob/d80aa01b893c39817f80b1ecea0efb75ea6969e1/LIDC/
        image-based_nodule_classification/patch_creation/deprecated/mat2gray.py
    """
    m = (np.asmatrix(m))
    m_min = np.min(m)
    m_max = np.max(m)
