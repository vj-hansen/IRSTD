...
def save_image( img_filename, image, acc, model, score_thresh,
                top_left_crner, btm_right_crner):
    cv2.rectangle(image, top_left_crner, btm_right_crner,
                 color = (0, 0, 255), thickness = 1)
    cv2.imwrite('/Users/victor/Google Drive/detection_pics/' + model + "_"
    			+ str(score_thresh) + acc + "_" + img_filename + '.jpg', image)
