...
for it, file in enumerate(filelist):
    ...
    if (number_of_boxes - GT_OBJECTS_IN_IMG > 0) and (GT_OBJECTS_IN_IMG != 0):
        ...
        for i in range(GT_OBJECTS_IN_IMG):
            ...
            save_image(	img_filename[it], images[it], "fp", MODEL, SCORE_THRESH,
        ...
        for j in range(GT_OBJECTS_IN_IMG):
            ...
            save_image(	img_filename[it], images[it], "fn", MODEL, SCORE_THRESH,
            			top_left_crner, btm_right_crner)

    elif (GT_OBJECTS_IN_IMG == 0) and (number_of_boxes > 0):
        FALSE_POS += 1
        cv2.imwrite('detection_pics/' + MODEL + "_"
        		+ str(SCORE_THRESH) + 'fp' + "_" + img_filename[it] + '.jpg', images[it])
        ...
        for i in range(number_of_boxes):
            ...
            W = (nimg.shape[1]) # - horizontal
            H = (nimg.shape[0]) # - vertical
            ...
            save_image(img_filename[it], images[it], "tp", MODEL, SCORE_THRESH,
            		   top_left_crner, btm_right_crner)
